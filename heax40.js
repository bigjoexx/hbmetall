  ...
  $(document).ready(function() {
    ...
    $addtocartbutton.on('click', function(event) {
      ...
      if (fusplatteCheckbox && fusplatteCheckbox.checked) {
        ...
        const productData = {
        productCode: "hbhea", // Replace with a unique identifier for the product
        productName: "HEA Stahltrager", // Replace with the actual product name
        priceWithVAT: "priceWithVAT", // Replace with the actual price with VAT
        configuration: {}, // Initialize as an empty object
        imageUrl: "your-image-url", // Replace with the actual image URL
        category: "your-category", // Replace with the actual category
        weight: "finalWeight", // Replace with the actual weight
      };
        
        for (const [key, value] of formData.entries()) {
      productData.configuration[key] = value;
    }
