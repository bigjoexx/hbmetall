...
const PricingModule = ((async () => {
    ...
    function _0x17e693(_0x5e3a53, _0x3b2486) {
        ...
        document[_0x369964(0x11f)]('[gift-name=\"' + _0x3bbac7 + _0x5e3a53 + '\"]')['forEach'](_0x50aaef => {
    ...
    const _0x146a45 = (_0x137bd8, _0x444f6b, _0x2ee16c) => {
        ...
        _0x2d6d9f = () => {
            ...
            case 'subscription':
                ...
                case 0x1:
                    ...
                    break;
                case 0x2:
                    _0x5ea16e[_0x521b47(0xb0)] = '2-pack discount';
                    break;
                case 0x3:
                    _0x5ea16e[_0x521b47(0xb0)] = '3-pack discount';
                    break;
                case 0x4:
        ...
        _0x65eb0b = async _0x3edda5 => {
            ...
            const _0x33c1ee = _0x2dee57,
                ...
                _0x3a6dca = document[_0x33c1ee(0xb2)]('[data-quantity=\"decrease\"]');
...
const closeDrawer = _0x3f8e2f => {
    ...
    ingredientButtons = document[_0x1d3cb3(0x11f)]('[data-drawer=\"ingredients\"]'),
...
function namePrefix(_0x15f060) {
    const _0x5aee0a = _0x1d3cb3,
        _0x5cad51 = _0x15f060[_0x5aee0a(0x112)](' '),
...
function createReviewHTML(_0x54b84d) {
    ...
    return colorCounter++,
        _0x4e1005(0xea) + _0x2e5df1 + _0x4e1005(0x13e) + namePrefix(_0x54b84d[_0x4e1005(0x10c)]) + _0x4e1005(0xa3) + _0x54b84d['name'] + _0x4e1005(0xf8) + _0x54b84d[_0x4e1005(0xbf)] + _0x4e1005(0xf1) + _0x54b84d[_0x4e1005(0xe7)] + _0x4e1005(0x132) + _0x54b84d[_0x4e1005(0x108)] + '</p>\x0a        </div>\x0a        <p class=\"text-weight-bold\">' + _0x54b84d[_0x4e1005(0xc2)] + _0x4e1005(0xc7) + _0x54b84d[_0x4e1005(0xf9)] + _0x4e1005(0xf4);
}

function _0x4789() {
    const _0x9e957b = ['error', 'substring', '39.99', 'stopPropagation', 'result', 'bundle-discount', '[data-quantity=\"display\"]', 'title', 'scrollY', '861NFwBmf', 'HTTP error! status: ', 'scroll', '</p>\x0a        <p class=\"text-size-small\">', 'location', '%26return_to=/checkout?', '%26items[', 'discount-amount', 'addEventListener', '%26attributes[checkoutSettings]=staticPrices%26attributes[saleSettings]=earlyAccessSale%26attributes[checkoutCheckmark]=hide%26deviceId=', 'gift0', 'discount=', 'charAt', '][id]=', 'hamburguer-menu', 'dataset', 'search', 'getItem', 'filter', 'reviewsContainer', '#F9F871', 'https://cloud.javycoffee.com/reviews/protein-coffee.json', 'eachPrice', '.nav-link-2', 'discount-name', 'selectedFrequency', '[data-action=\"proceed-checkout\"]', 'https://secure.javycoffee.com/cart/clear?return_to=/cart/add?', '4050IZudhr', 'loadMoreBtn', '%26attributes[productQty]=1%26attributes[currentQty]=1%26attributes[frequency]=', '1-pack discount', 'line_each', 'Failed to handle quantity change: ', '[data-frequency=\"one-time\"]', 'purchaseReason', '43019389960353', 'stringify', '\x0a    <div class=\"review1_component-item\">\x0a      <div class=\"review1_content review1_content-left\">\x0a        <div class=\"review1_heading\">\x0a          <div class=\"review1_prefix\" style=\"background-color: ', '[data-drawer=\"close-cart\"]', '#filterBtns .review1_filter-button', 'log', 'sticky_bar', 'includes', 'reduce', '</p>\x0a          </div>\x0a          <div class=\"review1_component-feature\">\x0a            <p class=\"text-weight-bold\">Purchase Reason</p>\x0a            <p class=\"text-size-xtiny\">', 'runningDiscount', '[data-frequency]', '</p>\x0a      </div>\x0a    </div>\x0a  ', 'max', 'LP51', '4-pack discount', '</p>\x0a            <div class=\"review1_verified-purchase\">\x0a              <img class=\"icon is-tiny\" src=\"https://cloud.javycoffee.com/images/check.svg\">\x0a              <p class=\"text-size-tiny text-weight-medium\">Verified Purchase</p>\x0a            </div>\x0a          </div>\x0a        </div>\x0a        <div class=\"review1_features\">\x0a          <div class=\"review1_results is-justified\">\x0a            <p class=\"text-weight-bold\">Result</p>\x0a            <p class=\"text-size-tiny\">', 'review', 'map', '879430BFhZeL', '#drawer-backdrop', '131394jLjABr', 'display', 'auto', '70048lcYeXK', '[data-action=\"add-to-cart\"]', '[data-frequency=\"subscription\"]', '6039WjWgzG', '#3D348B', 'bundle_coupon', 'forEach', 'items[0][id]=', 'date', '[data-drawer=\"close\"]', '[data-drawer=\"cart\"]', 'coupon', 'name', 'Failed to handle frequency change: ', 'none', '2-pack discount', '#FF8062', 'min', 'split', 'length', '2IwAWev', '#thumb-arrow-next-slide', 'javyCart', '#drawer-ingredients', '47178ahkNxu', '[data-swiper=hero-pagination]', '[data-quantity=\"increase\"]', 'one-time', 'classList', 'href', '9QTWOIM', 'querySelectorAll', 'toggle', 'savings-bubble', '#drawer-cart', '42984789016737', 'mobile-menu', 'toFixed', '[data-quantity=\"cart-bubble\"]', '203IzuzCh', '%26items[0][selling_plan]=', 'click', 'maxQuantity', '#slider-ugcs', 'line_compare', 'sale-banner-coupon', '[data-price=\"atc-button\"]', 'remove', 'selected-filter', '3068pGkrJR', '<br></p>\x0a          </div>\x0a        </div>\x0a      </div>\x0a      <div class=\"review1_content\">\x0a        <div class=\"review1_content-heading\">\x0a          <img src=\"https://assets.website-files.com/639237507f6bfe2bfd984ca9/643c47324d1e053549d6ff61_trustpilot-5-stars.svg\" loading=\"lazy\" alt=\"\" class=\"trustpilot-review-stars\">\x0a          <p class=\"text-size-xtiny color-gray\">', 'subscription', '%26items[0][quantity]=', 'is-active', 'toUpperCase', 'No special case for the current selection', 'open', 'json', '#thumb-arrow-prev-slide', '][quantity]=1', 'all', 'runningSavings', ';\">', '29.99', 'selectedQuantity', 'className', 'join', 'https://cloud.javycoffee.com/pricing_variants/protein-lp51.json', '</div>\x0a          <div>\x0a            <p class=\"text-size-medium text-weight-bold\">', 'You Save $20 + Free Shipping', 'frequency', '360HUfKxb', '91221ItJuam', 'init', 'submitting', '#slider-steps', 'preventDefault', '[data-quantity=\"line-bubble\"]', 'parse', 'innerHTML', 'current-frequency', 'textContent', 'block', 'querySelector', 'comparePrice', '#price_compare_price', 'add', '[data-quantity=\"decrease\"]', 'You save $10', 'style', 'getElementById', 'hamburger-menu or mobile-menu element not found'];
    _0x4789 = function () {
        return _0x9e957b;
    };
    return _0x4789();
...
var myScrollFunc = function () {
    ...
    _0x4a231b >= 0x76c ? stickyBar[_0x372de7(0x141)] = 'sticky_bar is-active' : stickyBar[_0x372de7(0x141)] = _0x372de7(0xee);
};
