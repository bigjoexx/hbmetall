...
const computeMaxPlatteAbstand = () => {
  ...
  // The distance from the edge should be such that the circles don't overlap.
  // This is achieved when the distance is at least half of the smaller dimension of the plate minus the radius of the hole.
  return Math.min(lange, breite) / 2 - bohrungenDurchmesser / 2;
};
