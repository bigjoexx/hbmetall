...
if (thickness < 6) {
  ...
  // Set the pre-selected value to '3 mm' or the user's selection if it exists
  kehlnahtstarkeSelection.value = selectedValueKehlnahtstarke || '3 mm';
} else {
  // Thickness is 6 or above, so add '5 mm' and '7 mm'
  kehlnahtstarkeSelection.add(new Option('5 mm', '5 mm'));
  kehlnahtstarkeSelection.add(new Option('7 mm', '7 mm'));

  // Set the pre-selected value to '5 mm' or the user's selection if it exists
  kehlnahtstarkeSelection.value = selectedValueKehlnahtstarke || '5 mm';
}
