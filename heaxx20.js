...
function calculateLengthPrice(traegerFormat, beamLength, pricesData) {
...
function calculateTotalPrice(selectedValues, pricesData, beamMenge, kopfplattePrice, fusplattePrice) {
  ...
  const lengthPrice = calculateLengthPrice(selectedValues.traegerFormat, parseInt(selectedValues.beamLength), pricesData);
