  ...
  function addToCart(formData, productData) {
    ...
    console.log("optionsPlainString", optionsPlainString);
    const foxyData = {
...
const kehlnahtstarkeSelect = document.getElementById('kopfplatte-kehlnahtstarke');

// Clear existing options
kehlnahtstarkeSelect.innerHTML = '';

// Update options based on traegerFormat
if (traegerFormat < 220) {
  updateSelectOptions(kehlnahtstarkeSelect, ['3 mm', '5 mm']);
} else {
  updateSelectOptions(kehlnahtstarkeSelect, ['5 mm', '7 mm']);
}

// Function to update option value in select element
...
if (traegerFormat < 220) {
  if (kehlnahtstarkeSelection === '3 mm' || kehlnahtstarkeSelection === '5 mm') {
    kehlnahtstarkePrice = (kehlnahtstarkeSelection === '3 mm') ? kehlnahtstarke3mm : kehlnahtstarke5mm;
  } else {
    kehlnahtstarkePrice = 0; // default value or handling for other cases
  }
} else {
  if (kehlnahtstarkeSelection === '5 mm' || kehlnahtstarkeSelection === '7 mm') {
    kehlnahtstarkePrice = (kehlnahtstarkeSelection === '5 mm') ? kehlnahtstarke5mm : kehlnahtstarke7mm;
  } else {
    kehlnahtstarkePrice = 0; // default value or handling for other cases
  }
}
...
function calculateFusplattePrice(fusplattePricesData, pricesData) {
  ...
  // Get the select element
const kehlnahtstarkeSelect = document.getElementById('fusplatte-kehlnahtstarke');

// Clear existing options
kehlnahtstarkeSelect.innerHTML = '';

// Add options based on traegerFormat
if (traegerFormat < 220) {
  addOption(kehlnahtstarkeSelect, '3 mm');
  addOption(kehlnahtstarkeSelect, '5 mm');
} else {
  addOption(kehlnahtstarkeSelect, '5 mm');
  addOption(kehlnahtstarkeSelect, '7 mm');
}
