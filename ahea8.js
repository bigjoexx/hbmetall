...
const bohrungenPrice = bohrungenPricePerHole * bohrungen;
  ...
  // Validate the bohrungen split
    ...
    if (totalBohrungenSplit !== bohrungen) {
        const errorMessage = "Bitte wählen Sie alle Bohrungen aus.";
        return { price: null, error: errorMessage };
    }

  // Function to update visibility of 'bohrungen-position-div'
    const bohrungenPositionDiv = parseInt(document.getElementById("bohrungen-position-div").value, 10);
    if (parseInt(bohrungen.value) !== 0) {
