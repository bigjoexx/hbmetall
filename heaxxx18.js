...
async function fetchPrices() {
  ...
  console.log("Prices data fetched:", prices);
...
async function updatePrice(pricesData, checkboxChanged = false) {
  ...
  console.log("Prices data before calling calculateTotalPrice:", pricesData);
  ...
  calculateFinalSurface(selectedValues, pricesData, selectedValues.traegerMenge);
...
(async () => {
  ...
  console.log("Prices data in initializePage:", pricesData);
