...
function createSVG() {
  ...
  const bohrungen = parseInt(document.getElementById("kopfplatte-bohrungen").value, 10);
  const bohrungenDurchmesser = parseInt(document.getElementById("kopfplatte-bohrungen-durchmesser").value, 10);
  const platteAbstand = parseInt(document.getElementById("platte-abstand").value, 10) - bohrungenDurchmesser / 2;
  ...
  if (bohrungen >= 2) createCircle(svg, svgns, lange - platteAbstand, breite - platteAbstand, bohrungenDurchmesser); // Bottom-right corner
  if (bohrungen >= 3) createCircle(svg, svgns, lange - platteAbstand, platteAbstand, bohrungenDurchmesser); // Top-right corner
