...
function getSelectedValues() {
  ...
  let oberflansch = parseInt(document.getElementById("bohrungen-oberflansch").value, 10);
  let steg = parseInt(document.getElementById("bohrungen-steg").value, 10);
  let unterflansch = parseInt(document.getElementById("bohrungen-unterflansch").value, 10);
  return {
    traegerFormat,
    laenge,
    stegbleche,
...
async function main() {
  ...
  document.getElementById("").addEventListener("change", () => updatePrice(pricesData));
