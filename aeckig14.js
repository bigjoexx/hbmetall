...
// Add '3 mm' and '5 mm' if thickness is below 6
if (thickness < 6) {
  kehlnahtstarkeSelection.add(new Option('3 mm', '3 mm'));
  kehlnahtstarkeSelection.add(new Option('5 mm', '5 mm'));
} else {
  // Add '5 mm' and '7 mm' if thickness is 6 or above
  kehlnahtstarkeSelection.add(new Option('5 mm', '5 mm'));
  kehlnahtstarkeSelection.add(new Option('7 mm', '7 mm'));
}

// Set the selected value, prioritizing the original selection
if (selectedValueKehlnahtstarke === '3 mm' || selectedValueKehlnahtstarke === '5 mm') {
  kehlnahtstarkeSelection.value = selectedValueKehlnahtstarke;
} else {
  // If the original selection is not available, set a default selection
