...
if (thickness < 6) {
  ...
  if (!kehlnahtstarkeSelection.value || kehlnahtstarkeSelection.value === '7 mm') {
  ...
  // Add '5 mm' and '7 mm' if not already present
  if (!kehlnahtstarkeSelection.querySelector('option[value="5 mm"]')) {
    kehlnahtstarkeSelection.add(new Option('5 mm', '5 mm'));
  }
  ...
  if (!kehlnahtstarkeSelection.value || kehlnahtstarkeSelection.value === '3 mm') {
