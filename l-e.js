  ...
  function getProductData() {
    ...
    const productCode = "hbl-e"; // Replace with the CMS code for the product
    const productName = "L-Profil Gleichseitig"; // Replace with the CMS name for the product
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/645aa5a091e70dc9135b4bba_L%20Equal.png"; // Replace with the CMS image URL for the product
...
async function fetchPrices() {
  ...
  const response = await fetch("https://api.airtable.com/v0/appIIKEo5ExPVPr9I/L-E?api_key=keyLAGDgC4VT8YzLb");
...
function calculateTotalPrice(selectedValues, pricesData, traegerMenge, finalWeight, finalSurface) {
  ...
  const totalPrice = (laengePrice + optionsPrice + baseCuttingPrice + feuerverzinkungPrice + vorgrundierungRotPrice + vorgrundierungGrauPrice) * traegerMenge;
