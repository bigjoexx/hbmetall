  ...
  function getProductData() {
    ...
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/64fae154a17ddc5fdde142b0_HEM-watermark.png"; // Replace with the CMS image URL for the product
...
async function fetchPrices() {
  ...
  const url = 'https://api.airtable.com/v0/appIIKEo5ExPVPr9I/HEM';
...
function calculateKopfplattePrice(kopfplattePricesData, pricesData) {
  ...
  const kehlnahtstarkePrice = parseFloat(pricesData[traegerFormat]["Kehlnahtstarke 7mm"]);
