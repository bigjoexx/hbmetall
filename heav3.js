...
function calculateKopfplattePrice(kopfplattePricesData, pricesData, selectedValues) {
  ...
  if (kehlnahtstarkeSelection === '3mm') {
    kehlnahtstarkePrice = kehlnahtstarke3mm;
  } else if (kehlnahtstarkeSelection === '5mm') {
...
function calculateFusplattePrice(fusplattePricesData, pricesData, selectedValues) {
  ...
  // Calculate other option prices
  const traegerFormat = selectedValues.traegerFormat;
  const kehlnahtstarkeSelection = document.getElementById('fusfplatte-kehlnahtstarke').value;
  const kehlnahtstarke3mm = parseFloat(pricesData[traegerFormat]["Kehlnahtstarke 3mm"]);
  const kehlnahtstarke5mm = parseFloat(pricesData[traegerFormat]["Kehlnahtstarke 5mm"]);
