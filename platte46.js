...
function createSVG() {
    ...
    svg.setAttributeNS(null, "width", lange);
    svg.setAttributeNS(null, "height", breite);
    ...
    // Create holes (circles)
    for(let i = 0; i < bohrungen; i++){
        let circle = document.createElementNS(svgns, "circle");
        circle.setAttributeNS(null, "cx", platteAbstand + i * (bohrungenDurchmesser + platteAbstand));
        circle.setAttributeNS(null, "cy", breite / 2);
        circle.setAttributeNS(null, "r", bohrungenDurchmesser / 2);
