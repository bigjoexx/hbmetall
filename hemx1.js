...
function calculateTotalPrice(selectedValues, pricesData, traegerMenge, kopfplattePrice, fusplattePrice, finalWeight, finalSurface) {
  ...
  const totalPrice = (laengePrice + optionsPrice + baseCuttingPrice + kopfplattePrice + fusplattePrice + feuerverzinkungPrice + vorgrundierungRotPrice + vorgrundierungGrauPrice) * traegerMenge;
