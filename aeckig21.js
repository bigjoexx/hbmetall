...
// Flag to track whether to pre-select the value
let preSelectValue = false;
...
function updateOptions() {
  ...
  if (thickness < 6) {
    ...
    // Set the pre-selected value to '3 mm' if it's the first change
    if (!preSelectValue) {
    ...
    // Set the pre-selected value to '5 mm' if it's the first change
    if (!preSelectValue) {
