  ...
  function getProductData() {
    ...
    const productCode = "hbhem"; // Replace with the CMS code for the product
    const productName = "HEM Stahlträger"; // Replace with the CMS name for the product
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/645aa5a03082e758b43af1f7_HEM%20R1.png"; // Replace with the CMS image URL for the product
...
async function fetchPrices() {
  ...
  const response = await fetch("https://api.airtable.com/v0/appIIKEo5ExPVPr9I/HEM?api_key=keyLAGDgC4VT8YzLb");
...
function updateDisplayedPrices(oldPriceWithoutVAT, oldPriceWithVAT, totalPrice, traegerMenge) {
  ...
  const foxyPrice = priceWithoutVAT / traegerMenge;
  console.log("Total price:", totalPrice);
  console.log("priceWithoutVAT:", priceWithoutVAT);
  console.log("priceWithVAT", priceWithVAT);
  console.log("traegerMenge", traegerMenge);
  console.log("VAT_RATE", VAT_RATE);
  console.log("foxyPrice", foxyPrice);
