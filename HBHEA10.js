...
for (const pair of formData.entries()) {
  ...
  if (value === 0 || value === "" || value.trim() === "") {
    ...
    formData.delete(name);
      ...
      if (kopfplatteCheckbox && kopfplatteCheckbox.checked) {
        ...
        const kopfplatteBohrungenPositionInput = document.querySelector('select[name="kopfplatte-bohrungen-position"]');
        ...
        if (kopfplatteBohrungenPositionInput) {
          formData.set('kopfplatte-bohrungen-position', kopfplatteBohrungenPositionInput.value);
        }
        ...
        formData.delete('kopfplatte-bohrungen-position');
      ...
      if (fusplatteCheckbox && fusplatteCheckbox.checked) {
        ...
        const fusplatteBohrungenPositionInput = document.querySelector('select[name="fusplatte-bohrungen-position"]');
        ...
        if (fusplatteBohrungenPositionInput) {
          formData.set('fusplatte-bohrungen-position', fusplatteBohrungenPositionInput.value);
        }
        ...
        formData.delete('fusplatte-bohrungen-position');
  ...
  function getProductData() {
    ...
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/64fae15078a92d721ca9e95e_hea-watermark.png"; // Replace with the CMS image URL for the product
