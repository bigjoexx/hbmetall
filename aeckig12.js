...
const selectedValuesKehlnahtstarke = Array.from(kehlnahtstarkeSelection.selectedOptions).map(option => option.value);
...
selectedValuesKehlnahtstarke.forEach(value => {
  const option = kehlnahtstarkeSelection.querySelector(`option[value="${value}"]`);
  if (option) {
