...
function calculateTotalPrice(kopfplattePricesData, traegerMenge, laenge, steelDensity) {
...
async function main() {
  ...
  document.getElementById("vorgrundierung-rot-checkbox").addEventListener("change", () => updatePrice(kopfplattePricesData));
  document.getElementById("vorgrundierung-grau-checkbox").addEventListener("change", () => updatePrice(kopfplattePricesData));
