  ...
  function getProductData() {
    ...
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/645aa5a03bb5e647d970dffa_Round.png"; // Replace with the CMS image URL for the product
...
function calculateTotalPrice(selectedValues, pricesData, traegerMenge, kopfplattePrice, fusplattePrice, finalWeight, finalSurface) {
  ...
  const totalPrice = (laengePrice + baseCuttingPrice + kopfplattePrice + fusplattePrice + feuerverzinkungPrice + vorgrundierungRotPrice + vorgrundierungGrauPrice) * traegerMenge;
