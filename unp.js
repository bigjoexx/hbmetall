  ...
  function getProductData() {
    ...
    const productName = "UNP Formstahl"; // Replace with the CMS name for the product
    const imageUrl = "https://uploads-ssl.webflow.com/6401aa505499a5c8687df64f/640258a7a141a94b35c68b88_Upn.png"; // Replace with the CMS image URL for the product
...
async function fetchPrices() {
  ...
  const response = await fetch("https://api.airtable.com/v0/appIIKEo5ExPVPr9I/UNP?api_key=keyLAGDgC4VT8YzLb");
...
function getSelectedValues() {
  ...
  const weiteres = document.getElementById("weiteres").value;
...
function calculateOptionsPrice(selectedValues, pricesData) {
  ...
  const weiteresOption = document.getElementById("weiteres").value;
...
console.log("Bohrungen price:", bohrungenPrice);
  ...
  console.log("ankerpratzen price:", ankerpratzenPrice);
  console.log("Weiteres price:", weiteresPrice);

  const optionsPrice = stegblechePrice + ausklinkungenPrice + buegelPrice + ankerpratzenPrice + weiteresPrice + bohrungenPrice;
  return optionsPrice;
}
...
async function main() {
  ...
  document.getElementById("weiteres").addEventListener("change", () => updatePrice(pricesData));
