...
function calculateKopfplattePrice(kopfplattePricesData, steelDensity) {
  ...
  const buegelPrice = parseFloat(kopfplattePricesData["buegel"][buegel.toString()]) * buegel;

  const kopfplattePrice = sizePrice + bohrungenPrice + baseCuttingPriceKopfplatte + dornePrice;
