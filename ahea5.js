  ...
  const bohrungenSelect = document.getElementById('kopfplatte-bohrungen');
    const bohrungenPositionContainer = document.getElementById('kopfplatte-bohrungen-position-container');

    bohrungenSelect.addEventListener('change', () => {
        if (bohrungenSelect.value === '2') {
            bohrungenPositionContainer.style.display = 'block';
        } else {
            bohrungenPositionContainer.style.display = 'none';
        }
    });
});
