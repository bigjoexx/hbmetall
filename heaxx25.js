...
function getSelectedValues() {
  ...
  const bugel = parseInt(document.getElementById("bugel").value, 10);
...
function calculateOptionsPrice(selectedValues, pricesData) {
  ...
  const bugelPrice = parseFloat(pricesData[traegerFormat]["bugel"]) * bugel;
...
async function main() {
  ...
  document.getElementById("bugel").addEventListener("change", () => updatePrice(pricesData));
  document.getElementById("weiteres").addEventListener("change", () => updatePrice(pricesData));
  document.getElementById("hbohrungen").addEventListener("change", () => updatePrice(pricesData));
